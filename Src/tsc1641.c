...
static HAL_StatusTypeDef TSC1641_SetConf2(I2C_HandleTypeDef *hi2c1, RegConfiguration * conf);
static HAL_StatusTypeDef TSC1641_SetRShunt(I2C_HandleTypeDef *hi2c1);
static HAL_StatusTypeDef TSC1641_SetMask(I2C_HandleTypeDef *hi2c1, RegMask* reg);
static HAL_StatusTypeDef TSC1641_SetLimits(I2C_HandleTypeDef *hi2c1, Limit* LIMIT);
...
static void TSC1641_GetCurrentVal(I2C_HandleTypeDef *hi2c1, uint8_t Data[]);
...
TSC1641StatusT TSC1641SetConf( TSC1641_NUM_T instance, RegConfiguration * conf ){
	...
	if( instance >= NUM_OF_INSTANCES || NULL == tsc_handles[ instance ].i2c_handle ){
		retval = TSC1641_STATUS_ERROR;
	}else{
		retval = TSC1641_SetConf2( &hi2c1, conf ) == HAL_OK ? TSC1641_STATUS_OK : TSC1641_STATUS_ERROR;
	}
...
TSC1641StatusT TSC1641SetRShunt( TSC1641_NUM_T instance ){
	...
	if( instance >= NUM_OF_INSTANCES || NULL == tsc_handles[ instance ].i2c_handle ){
		...
		retval = TSC1641_SetRShunt( tsc_handles[ instance ].i2c_handle ) == HAL_OK ? TSC1641_STATUS_OK : TSC1641_STATUS_ERROR;
	}
...
TSC1641StatusT TSC1641SetLimits( TSC1641_NUM_T instance , Limit* LIMIT){
	...
	if( instance >= NUM_OF_INSTANCES || NULL == tsc_handles[ instance ].i2c_handle ){
		...
		retval = TSC1641_SetLimits( tsc_handles[ instance ].i2c_handle, LIMIT ) == HAL_OK ? TSC1641_STATUS_OK : TSC1641_STATUS_ERROR;
	}
...
TSC1641StatusT TSC1641SetMask( TSC1641_NUM_T instance, RegMask* reg){
	...
	if( instance >= NUM_OF_INSTANCES || NULL == tsc_handles[ instance ].i2c_handle ){
		...
		retval = TSC1641_SetMask( tsc_handles[ instance ].i2c_handle, reg ) == HAL_OK ? TSC1641_STATUS_OK :TSC1641_STATUS_ERROR;
	}
...
double TSC1641GetCurrentAmp( TSC1641_NUM_T instance ){
	if( instance >= NUM_OF_INSTANCES || NULL == tsc_handles[ instance ].i2c_handle ){
		...
		TSC1641_GetCurrentVal( tsc_handles[ instance ].i2c_handle, DataCurrent );
...
static HAL_StatusTypeDef TSC1641_SetConf2(I2C_HandleTypeDef *hi2c1, RegConfiguration * pCnf){
	uint8_t data[ 2 ] = { 0x00, 0x00 };
	data[ 0 ] = ( pCnf->bitbuffer >> 8 );
	data[ 1 ] = ( pCnf->bitbuffer & 0xFF );
	uint8_t datasend[3] = { TSC1641_RegAdd_Conf, data[0], data[1] };
	return HAL_I2C_Master_Transmit( hi2c1, I2C_TSC1641_ADD_W, &datasend[0], 3, 1000 );
}
...
static HAL_StatusTypeDef TSC1641_SetLimits(I2C_HandleTypeDef *hi2c1, Limit* LIMIT){
	...
	HAL_StatusTypeDef retval = HAL_I2C_Master_Transmit(hi2c1, I2C_TSC1641_ADD_W, &datasend[0], 3, 1000);
	...
	retval = HAL_I2C_Master_Transmit(hi2c1, I2C_TSC1641_ADD_W, &datasend[0], 3, 1000);
